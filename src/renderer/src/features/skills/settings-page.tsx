...
export function SettingsPage({ onSave, onBack }: SettingsPageProps): ReactElement {
  ...
  return (
    <ScrollArea className="h-full">
      <div className="flex min-h-full flex-col">
        ...
        {!draft ? (
          <div className="flex flex-1 items-center justify-center text-[13px] text-muted-foreground">加载中…</div>
        ) : (
