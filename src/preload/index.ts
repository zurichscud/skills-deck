...
const api: SkillApi = {
  ...
  deleteSkill: (skillId: string): Promise<SetEnabledResult> => ipcRenderer.invoke('skills:delete', skillId),
  revealInFinder: (skillId: string): Promise<void> => ipcRenderer.invoke('skills:revealInFinder', skillId),
  ...
  saveSettings: (next: AppSettings): Promise<SetEnabledResult> => ipcRenderer.invoke('settings:save', next),
